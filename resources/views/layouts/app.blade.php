                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @guest
                            ...
                            @if (Route::has('register'))
                                <li class="nav-item">
                                    <a class="text-sm text-white dark:text-gray-500 text-decoration-none" href="{{ route('register') }}"><button class="btn rounded-pill" style="background-color: #ffa2a2; color:white">{{ __('Register') }}</button></a>
                                </li>
                            @endif
                        @else
